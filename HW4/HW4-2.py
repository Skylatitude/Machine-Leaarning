...
def classify(DataSet, colum, threshold, mark):
	...
	if colum == 1 or colum == 2 or colum == 7 or colum == 10 or colum == 13 or colum == 14:
		if mark == 'small':
...
def adaboost(DataSet):
	...
	while (1):
		...
		if errate == 0.0 or iteration >= 20 : break
	predictval, err = adaboosttest(DataSet, result)
	print 'The training err is: %f' %(1-err)
	return result
...
DataSet = loadData('/Users/skylatitude/downloads/crx/crx.data')
